...
public class EntityLOCKeeper {
	private int loc, headers, innerEntitiesLOC, annotations;
	...
	public EntityLOCKeeper(LOCCountPerEntity locCounter, boolean isInner) {
		...
		this.annotations = locCounter.getAnnot();
	}
	...
	/**
	 * Returns the Accontation Count of an entity
	 * @return
	 */
	public int getAnnotationsLOC() {
		return annotations;
	}
