...
import Vocabulary.Processors.StringProcessorC;
/**
...
public class CommentUnitC {
	 ...
	 */
	public CommentUnitC(ASTNode commentNode, String sourceCode) {
	...
	private void extractValue(String sourceCode) {
		...
		content = StringProcessorC.processString(sourceCode.substring(begin, end));
	}
