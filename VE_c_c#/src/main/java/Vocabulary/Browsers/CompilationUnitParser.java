...
{
	protected static IASTTranslationUnit translationUnit;
	...
	{
		for(IASTComment element : Arrays.asList(translationUnit.getComments()))
		{
			CompilationUnitProcessor.addCommentUnitC(new CommentUnitC((ASTNode)element, sourceCode));
		}
	}
}
