...
public class StructProcessor
{
	...
	public StructProcessor(CASTCompositeTypeSpecifier compositeType, boolean scope)
	{
		vxlFragment = new StringBuffer();
		
		//Efetua contagem de loc por entidade
		LOCCountPerEntity locCounter = new LOCCountPerEntity((ASTNode)compositeType, CompilationUnitProcessor.commentList, CompilationUnitProcessor.sourceCode, new LinkedList<ASTNode>(), 0);
