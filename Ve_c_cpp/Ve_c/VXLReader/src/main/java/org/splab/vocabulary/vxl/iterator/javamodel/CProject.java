...
@XmlType(name = "", propOrder = { "cFile" })
@XmlRootElement(name = "c-project")
public class CProject {

	@XmlElement(name = "c-file", required = true)
	protected List<CFile> cFile;
	...
	/**
	 * Obt�m o valor da propriedade cFile.
	 * 
	 * @return possible object is {@link CProject.CFile }
	 * 
	 */
	public List<CFile> getCFile() {
		if (this.cFile == null) {
			this.cFile = new ArrayList<CFile>();
		}
	...
	/**
	 * Define o valor da propriedade cFile.
	 * 
	 * @param value
	 *            allowed object is {@link CProject.CFile }
	 * 
	 */
