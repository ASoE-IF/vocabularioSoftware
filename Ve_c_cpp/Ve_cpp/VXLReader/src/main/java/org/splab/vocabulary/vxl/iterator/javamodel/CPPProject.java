...
@XmlType(name = "", propOrder = { "cppFile" })
@XmlRootElement(name = "cpp-project")
public class CPPProject {

	@XmlElement(name = "cpp-file", required = true)
	protected List<CPPFile> cppFile;
	 ...
	 * 
	 * @return possible object is {@link CPPProject.CPPFile }
	 * 
	 */
	public List<CPPFile> getCPPFile() {
		if (this.cppFile == null) {
			this.cppFile = new ArrayList<CPPFile>();
		}
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link CPPProject.CPPFile }
	 * 
	 */
	public void addCFile(CPPFile cppFile) {
		if (this.cppFile == null) {
			this.cppFile = new ArrayList<CPPFile>();
		}

		this.cppFile.add(cppFile);
	}
