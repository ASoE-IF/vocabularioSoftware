...
@XmlType(name = "cppFile", propOrder = { "comm", "include", "pragma", "error", "macro", "gvar", "lit", "prttp", "call",
		"_enum", "union", "strt", "func", "clazz" })
public class CPPFile {
	 ...
	 * <p>
	 * Objects of the following type(s) are allowed in the list
	 * {@link CPPProject.CPPFile.Include }
	 * 
	 * 
	 */
	 ...
	 * <p>
	 * Objects of the following type(s) are allowed in the list
	 * {@link CPPProject.CPPFile.Pragma }
	 * 
	 * 
	 */
	 ...
	 * <p>
	 * Objects of the following type(s) are allowed in the list
	 * {@link CPPProject.CPPFile.CPPError }
	 * 
	 * 
	 */
	public List<CPPError> getError() {
		if (this.error == null) {
			this.error = new ArrayList<CPPError>();
		}
		return this.error;
	}

	public void addError(CPPError error) {
		if (this.error == null) {
			this.error = new ArrayList<CPPError>();
		}
	 ...
	 * <p>
	 * Objects of the following type(s) are allowed in the list
	 * {@link CPPProject.CPPFile.Literal }
	 * 
	 * 
	 */
	 ...
	 * <p>
	 * Objects of the following type(s) are allowed in the list
	 * {@link CPPProject.CPPFile.Prototype }
	 * 
	 * 
	 */
