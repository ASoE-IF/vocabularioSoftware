 ...
 * Modificado por: Israel Gomes de Lima Para funcionamento no presente extrator
 */
public abstract class VxlManager {
	...
	public static String startProject(String projectName, String projectRevision) {
		return "<cpp-project id=\"default\" name=\"" + projectName + "\" revision=\"" + projectRevision + "\">" + "\n";
	}
	...
	public static String startFile(String fileName, int sloc) {
		return "\t<cpp-file name=\"" + fileName + "\" sloc=\"" + sloc + "\">" + "\n";
	}
	 ...
	 * @return The global variable fragment of the VXL file.
	 */
	public static String globalVariable(String variableName, String access, String storage, int occurrences, int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
		return indentation + "<gvar name=\"" + variableName + "\" access=\"" + access + "\" storage=\"" + storage + "\" count=\""
				+ occurrences + "\"/>" + "\n";
	}
	 ...
	 * @return The field fragment of the VXL file.
	 */
	public static String field(String fieldName, String access, String storageClass, String visibility, int occurrences, int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
		return indentation + "<field name=\"" + fieldName + "\" access=\"" + access + "\" storage=\"" + storageClass + "\" visib=\"" + visibility + "\" count=\""
		+ occurrences + "\"/>" + "\n";
	}
	 ...
	 * 			The class name.
	 * @param isAbstract
	 * 			A string indicating if the class is abstract or not. Use 'y' if it's and 'n' otherwise.
	 * @param isInner
	 * 			A string indicating if the class is inner or not. Use 'y' if it's and 'n' otherwise.
	 * @param sloc
	 * 			The number of LOC of the class.
	 * @param indentationLevel
	 *            The class VXL File Indentation Level.
	 * @return The start class fragment of the VXL file.
	 */
	public static String startClass(String className, String isAbstract, String isInner, int sloc, int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
		return indentation + "<class name=\"" + className + "\" abs=\"" + isAbstract + "\" inn=\"" + isInner + "\" sloc=\"" + sloc + "\">" + "\n";
	}
	 ...
	 * @return The end class fragment of the VXL file.
	 */
	public static String endClass(int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
	 ...
	 * 			The method access.
	 * @param storage
	 * 			The method class storage.
	 * @param modifier
	 * 			The method modifier
	 * @param visibility
	 * 			The method visibility.
	 * @param sloc
	 * 			The number of LOC of the method.
	 * @param indentationLevel
	 *          The method VXL File Indentation Level.
	 * @return The start method fragment of the VXL file.
	 */
	public static String startMethod(String methodName, String access, String storage, String modifier, String visibility, String isVirtual, int sloc, int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
		return indentation + "<mth name=\"" + methodName + "\" access=\"" + access + "\" storage=\"" + storage + "\" modifies=\"" + modifier + "\" visib=\"" + visibility + "\" virtual=\"" + isVirtual + "\" sloc=\"" + sloc + "\">" + "\n";
	}
	 ...
	 * @return The end method fragment of the VXL file.
	 */
	public static String endMethod(int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
		return indentation + "</mth>" + "\n";
	}
	
	
	/**
	 * Return the start method pure virtual fragment of the VXL file.
	 * @param methodName
	 * 			The method name.
	 * @param access
	 * 			The method access.
	 ...
	 * 			The method visibility.
	 * @param isPureVirtual
	 * 			A string indicating if the method is pure-virtual or not. Use 'y' if it's and 'n' otherwise.
	 * @param indentationLevel
	 *          The class VXL File Indentation Level.
	 * @return The start method pure virtual fragment of the VXL file.
	 */
	public static String methodPureVirtual(String methodName, String access, String storage, String modifier, String visibility, int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
		return indentation + "<mth name=\"" + methodName + "\" access=\"" + access + "\" storage=\"" + storage + "\" modifies=\"" + modifier + "\" visib=\"" + visibility + "\" pvirtual=\"y" + "\"/>" + "\n";
	}
	
	/**
	 * Return the start method prototype fragment of the VXL file.
	 * @param methodName
	 * 			The method name.
	 * @param access
	 * 			The method access.
	 ...
	 * 			The method visibility.
	 * @param isPureVirtual
	 * 			A string indicating if the method is prototype method or not. Use 'y' if it's and 'n' otherwise.
	 * @param indentationLevel
	 *          The class VXL File Indentation Level.
	 * @return The start method prototype fragment of the VXL file.
	 */
	public static String methodPrototype(String methodName, String access, String storage, String modifier, String visibility, String isVirtual, int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
		return indentation + "<mth name=\"" + methodName + "\" access=\"" + access + "\" storage=\"" + storage + "\" modifies=\"" + modifier + "\" visib=\"" + visibility + "\" virtual=\"" + isVirtual + "\"/>" + "\n";
	}
	 ...
	 * @return The start function fragment of the VXL file.
	 */
	public static String startFuntion(String functionName, String access, String storage, int sloc, int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
		return indentation + "<func name=\"" + functionName + "\" access=\"" + access + "\" storage=\"" + storage + "\" sloc=\""
				+ sloc + "\">" + "\n";
	}
	 ...
	 * @return The local variable fragment of the VXL file.
	 */
	public static String localVariable(String variableName, String access, String storage, int occurrences, int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
		return indentation + "<lvar name=\"" + variableName + "\" access=\"" + access + "\" storage=\"" + storage + "\" count=\""
				+ occurrences + "\"/>" + "\n";
	}
