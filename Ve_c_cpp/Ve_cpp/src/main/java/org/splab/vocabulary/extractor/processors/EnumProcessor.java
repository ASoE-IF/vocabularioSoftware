...
/**
 * EnumProcessor é responsável por receber um tipo enum
 * e tratálo, obtendo suas inforções, tais como seu nome
 * e o de suas constantes.
 * 
...
public class EnumProcessor
{
	 ...
	 */
	public EnumProcessor(CPPASTEnumerationSpecifier enumDeclaration, int indentationLevel) {
		...
		vxlFragment.append(VxlManager.startEnum(enumDeclaration.getName().toString(), locKeeper.getLOC(), indentationLevel));
