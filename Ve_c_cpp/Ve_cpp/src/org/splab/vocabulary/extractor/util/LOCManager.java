...
public class LOCManager {
	...
	public static void appendEntityLOCData(String typeName, EntityLOCKeeper entity, EntityType entityType) {
		...
		int total = entity.getLOC() + entity.getInnerEntitiesLOC();
		entitiesLOCContent.append("\n," + typeName + "," +	(entity.getLOC() - entity.getHeaderLOC())+ "," +  entity.getHeaderLOC() + "," + entity.getInnerEntitiesLOC() + "," + total + "," + entityType.name());
		
		totalLOC += entity.getLOC() - entity.getHeaderLOC();
