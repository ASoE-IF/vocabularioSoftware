...
public abstract class VxlManager {
	 ...
	 * @return The field fragment of the VXL file.
	 */
	public static String field(String fieldName, String visibility, String access, String storageClass) {
		return "\t\t\t<field name=\"" + fieldName + "\" access=\"" + access + "\" visibility=\"" + visibility + "\" storage=\"" + storageClass + "\"/>" + "\n";
	}
	 ...
	 * @return The start method fragment of the VXL file.
	 */
	public static String startMethod(String methodName, String access, String storage, String modificador, String visibility, int sloc) {
		return "\t\t<mth name=\"" + methodName + "\" access=\"" + access + "\" storage=\"" + storage + "\" modifies=\"" + modificador + "\" visibility=\"" + visibility + "\" sloc=\"" + sloc + "\">" + "\n";
	}
	 ...
	 * @return The start class fragment of the VXL file.
	 */
	public static String startClass(String className, String isInner, int sloc) {

		return "\t\t<class name=\"" + className + "\" inn=\"" + isInner + "\" sloc=\"" + sloc + "\">" + "\n";
	}
	...
	public static String startFuntion(String functionName, String access, String storage, int sloc) {
		...
		return "\t\t<func name=\"" + functionName + "\" access=\"" + access + "\" storage=\"" + storage + "\" sloc=\""
				+ sloc + "\">" + "\n";
	}
