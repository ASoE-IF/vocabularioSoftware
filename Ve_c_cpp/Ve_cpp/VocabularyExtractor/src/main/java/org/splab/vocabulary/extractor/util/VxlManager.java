...
public abstract class VxlManager {
	 ...
	 * @return The field fragment of the VXL file.
	 */
	public static String field(String fieldName, String access, String storageClass, String visibility, int occurrences,
			int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
		return indentation + "<field name=\"" + fieldName + "\" access=\"" + access + "\" storage=\"" + storageClass
				+ "\" visib=\"" + visibility + "\" count=\"" + occurrences + "\"/>" + "\n";
	}
	 ...
	 *            The class name.
	 * @param isAbstract
	 *            A string indicating if the class is abstract or not. Use 'y'
	 *            if it's and 'n' otherwise.
	 * @param isInner
	 *            A string indicating if the class is inner or not. Use 'y' if
	 *            it's and 'n' otherwise.
	 * @param sloc
	 ...
	 * @return The start class fragment of the VXL file.
	 */
	public static String startClass(String className, String isAbstract, String isInner, int sloc,
			int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
		return indentation + "<class name=\"" + className + "\" abs=\"" + isAbstract + "\" inn=\"" + isInner
				+ "\" sloc=\"" + sloc + "\">" + "\n";
	}
	 ...
	 * @return The start method fragment of the VXL file.
	 */
	public static String startMethod(String methodName, String access, String storage, String modifier,
			String visibility, String isVirtual, int sloc, int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
		return indentation + "<mth name=\"" + methodName + "\" access=\"" + access + "\" storage=\"" + storage
				+ "\" modifies=\"" + modifier + "\" visib=\"" + visibility + "\" virtual=\"" + isVirtual + "\" sloc=\""
				+ sloc + "\">" + "\n";
	}
	 ...
	 *            The method visibility.
	 * @param isPureVirtual
	 *            A string indicating if the method is pure-virtual or not. Use
	 *            'y' if it's and 'n' otherwise.
	 * @param indentationLevel
	 *            The class VXL File Indentation Level.
	 * @return The start method pure virtual fragment of the VXL file.
	 */
	public static String methodPureVirtual(String methodName, String access, String storage, String modifier,
			String visibility, int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
		return indentation + "<mth name=\"" + methodName + "\" access=\"" + access + "\" storage=\"" + storage
				+ "\" modifies=\"" + modifier + "\" visib=\"" + visibility + "\" pvirtual=\"y" + "\"/>" + "\n";
	}
	 ...
	 *            The method visibility.
	 * @param isPureVirtual
	 *            A string indicating if the method is prototype method or not.
	 *            Use 'y' if it's and 'n' otherwise.
	 * @param indentationLevel
	 *            The class VXL File Indentation Level.
	 * @return The start method prototype fragment of the VXL file.
	 */
	public static String methodPrototype(String methodName, String access, String storage, String modifier,
			String visibility, String isVirtual, int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
		return indentation + "<mth name=\"" + methodName + "\" access=\"" + access + "\" storage=\"" + storage
				+ "\" modifies=\"" + modifier + "\" visib=\"" + visibility + "\" virtual=\"" + isVirtual + "\"/>"
				+ "\n";
	}
	 ...
	 * @return The start function fragment of the VXL file.
	 */
	public static String startFuntion(String functionName, String access, String storage, int sloc,
			int indentationLevel) {
		String indentation = getIndentation(indentationLevel);
