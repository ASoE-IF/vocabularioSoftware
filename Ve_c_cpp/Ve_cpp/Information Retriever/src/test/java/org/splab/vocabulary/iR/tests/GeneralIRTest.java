...
public abstract class GeneralIRTest extends TestCase {
	...
	protected final String PERSON = "Person.cpp";
	protected final String OFFICE = "Office.cpp";
	protected final String EMPLOYEE = "Employee.cpp";
	protected final String HOUSE = "House.cpp";
